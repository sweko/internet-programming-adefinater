# Grading Breakdown - PR #4

**Student:** MidTerm5941
**Student ID:** 
**GitHub:** @barbaraveljkovaa
...
|----------|-------|------------|
| **Tier 1** (Basic Functionality) | 55 / 60 | 92% |
...
AutoTest: 90% | T1=55/60 (92%) | T2=20/25 (80%) | T3=10/40 (25%) | Bonus: +5 | Multiple HTTP sources (7 sources) - BONUS!

# Grading Breakdown - PR #24

**Student:** Leon Lazarov 5819
**Student ID:** 
**GitHub:** @LeonLazarov
...
|----------|-------|------------|
| **Tier 1** (Basic Functionality) | 60 / 60 | 100% |
...
AutoTest: 100% | T1=60/60 (100%) | T2=25/25 (100%) | T3=10/40 (25%) | Bonus: +5 | Multiple HTTP sources (6 sources) - BONUS!
